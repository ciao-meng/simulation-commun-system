...
ChanBW = 4.8e+5;					    % bandwidth of channel (Hz),太大会影响ISI的效果
...
%
[b,a] = butter(2,ChanBW/(fs/2));%增加滤波器，产生ISI
% b=[1]; a=[1];									% filter bypassed，即无ISI的设置 
[TxBits,FilterState]=filter(b,a,TxBits);
%
